...
class IntersectPolylinePlaneNode(bpy.types.Node, AnimationNode):
    ...
    def create(self):
        ...
        self.outputs.new("an_VectorListSocket", "Intersections List", "intersections")
        self.outputs.new("an_IntegerListSocket", "Intersected Edge Index", "cutEdges").hide = True
        self.outputs.new("an_IntegerListSocket", "Intersected Edge Plane Side", "cutEdgesDir").hide = True
